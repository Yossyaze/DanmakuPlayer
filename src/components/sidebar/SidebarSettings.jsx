...
import { 
    ChevronUp, Upload, Clock, RefreshCw, 
    Link as LinkIcon
} from 'lucide-react';
...
const SidebarSettings = ({
    ...
    React.useEffect(() => {
        console.log('[SidebarSettings] mounted. handleReorderFiles:', typeof handleReorderFiles, handleReorderFiles);
                ...
                <div className="p-4 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <DndContext
                            ...
                            onDragStart={(event) => console.log('[SidebarSettings] onDragStart', event.active?.id)}
