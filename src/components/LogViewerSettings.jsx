...
import { X, Type, LayoutList, Image as ImageIcon, AlignLeft, Eye } from 'lucide-react';
                ...
                <div className="space-y-2">
                    ...
                    <div className="space-y-1">
                        {[
                            ...
                            { id: 'showThumbnails', label: '画像を小さく表示', icon: null, disabled: !settings.showImages, indent: true },
                            ...
                            <button
                                ...
                                className={`w-full flex items-center justify-between px-3 py-2 rounded text-sm transition-colors ${
                                    opt.disabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-800 cursor-pointer'
                                }`}
                            >
