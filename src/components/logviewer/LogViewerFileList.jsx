            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin p-2 space-y-1">
                ...
                {files.map(file => (
                    <button
                        ...
                        className={`w-full text-left px-3 py-3 rounded-md text-sm transition-colors group ${
                            selectedFileId === file.id
                            ? 'bg-blue-600/20 text-blue-400 border border-blue-600/30' 
                            : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800'
                        }`}
                    >
                        <div className="font-medium text-gray-200 leading-snug wrap-break-word line-clamp-3" title={file.name || file.title}>
