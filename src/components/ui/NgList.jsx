                    ...
                    <div className="bg-gray-950 border border-gray-800 rounded max-h-48 overflow-y-auto scrollbar-thin p-1 space-y-1">
                        {ngSettings.ids.map(id => {
                            ...
                            if (!comment) {
                                ...
                                return (
                                    <div key={id} className="flex items-center justify-between text-xs bg-gray-900 p-2 rounded border border-gray-800/50 text-gray-500">
                                        <span 
                            ...
                            return (
                                <div key={id} className="flex flex-col gap-1 text-xs bg-gray-900 p-2 rounded border border-gray-800/50 hover:border-gray-700 transition-colors group">
                                     {/* Header: ResNum Name Date ID */}
                                     <div className="flex justify-between items-start">
                                        <div className="flex flex-wrap gap-x-2 text-[10px] text-gray-500 leading-tight">
                                            <span className="font-bold text-gray-400">{comment.originalResNum || comment.resNum}</span>
                    ...
                    <div className="bg-gray-950 border border-gray-800 rounded max-h-64 overflow-y-auto scrollbar-thin p-1 space-y-1">
                        {ngSettings.comments.map(commentId => {
                            ...
                            if (!comment) {
                                ...
                                return (
                                    <div key={commentId} className="flex items-center justify-between text-xs bg-gray-900 p-1.5 rounded text-gray-500">
                            ...
                            return (
                                <div key={commentId} className="flex flex-col gap-1 text-xs bg-gray-900 p-2 rounded border border-gray-800/50 hover:border-gray-700 transition-colors group">
                                    {/* Header: ResNum Name Date ID */}
                                    <div className="flex justify-between items-start">
                                        <div className="flex flex-wrap gap-x-2 text-[10px] text-gray-500 leading-tight">
                                            <span className="font-bold text-gray-400">{comment.originalResNum || comment.resNum}</span>
