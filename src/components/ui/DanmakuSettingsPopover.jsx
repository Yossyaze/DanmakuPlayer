            ...
            <div className="space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            onChange={e => setDmSettings({ ...dmSettings, duration: parseFloat(e.target.value) })}
                ...
                <div className="space-y-1">
                    ...
                    <input
                        ...
                        onChange={e => setDmSettings({ ...dmSettings, fontSize: parseInt(e.target.value) })}
                ...
                <div className="space-y-1">
                    ...
                    <input
                        ...
                        onChange={e => setDmSettings({ ...dmSettings, opacity: parseFloat(e.target.value) })}
                        className="w-full h-1 bg-gray-600 rounded accent-blue-500 cursor-pointer"
                    />
                </div>
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            onChange={e => setDmSettings({ ...dmSettings, area: parseInt(e.target.value) })}
                            className="flex-1 h-1 bg-gray-600 rounded accent-blue-500 cursor-pointer"
                        />
