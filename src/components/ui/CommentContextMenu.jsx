...
import { Play, Clock, ArrowRightToLine, ArrowLeftToLine, Ban, Trash2, Type, X } from 'lucide-react';
import CommentItem from './CommentItem';
import { isProbablyAA } from '../../utils/aaUtils';

const CommentContextMenu = ({ comment, onClose, onSeek, onSetLogStart, onSetCmStart, onSetCmEnd, onAddNgId, onAddNgComment, formatTime, timeOffset = 0, totalComments = 0, onJumpToComment, onToggleAA, aaMode, aaOverride }) => {
            ...
            >
                ...
                <div className="py-2 space-y-1">
                    ...
                    <button
                        ...
                        onClick={() => {
                            if (window.confirm(`ID:${comment.userId} をNGに追加しますか？\nこのIDの書き込みが表示されなくなります。`)) {
