      ...
      <div className="bg-gray-900 border border-gray-700 rounded-xl shadow-2xl w-full max-w-5xl flex flex-col max-h-[85vh] min-h-[600px]">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-[320px] bg-gray-900/50 border-r border-gray-800 p-6 overflow-y-auto custom-scrollbar flex flex-col gap-6">
            ...
            {/* 2. Preview Settings */}
            <div
              className={`transition-opacity duration-200 flex-1 flex flex-col ${!localSettings.enabled ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}
            >
          ...
          <div
            className={`flex-1 p-6 overflow-hidden flex flex-col transition-opacity duration-200 ${!localSettings.enabled ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}
          >
                  ...
                  <div className="flex flex-col gap-4 h-full">
                    <div className="flex gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setLocalSettings({ ...localSettings, value: e.target.value })
                        }
                      />
                    </div>
